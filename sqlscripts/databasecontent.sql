...
insert into FilmPerson values(2,'Jorunn',1999,'Norge',True,False,False);
insert into FilmPerson values(3,'Airin',1999,'Norge',False,True,True);
insert into Bruker values(1)
...
insert into RegissorTilFilm values(2,1);
insert into ForfatterIFilm values(3,101);
